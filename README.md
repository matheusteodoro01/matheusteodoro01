...
Conhecimento em linguagens de programação e ferramentas: Docker, Kubernets, Node.js, Nest.js, JavaScript, TypeScript, React, Mongo DB, MySQL, PostgreSQL, ElasticSearch, DialogFlow entre outros. Com habilidades avançadas em infraestrutura de TI cloud e on promisse em ferramentas como Terra Form. AWS, Windows Server, Vm Ware, Zabbix, Grafana, Veeam e Active Directo.
